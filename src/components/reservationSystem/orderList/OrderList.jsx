            ...
            <React.Fragment className="user-account-wrapper">
                ...
                <div className="user-account__header-btn-wrapper">
                    <Link to="/flight-search">
                        <Button className="button button--user-account-header-btn user-account-header-btn--btn1"
                ...
                <div className="user-account__orders">
                    ...
                    <div className="orders__main">
                        <div className="orders__filters">
                            <Button className="button orders__filters--past" caption="Past orders" />
                            <Button className="button orders__filters--current" caption="Current orders" />
                        </div>
